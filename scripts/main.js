...
function buildPromoBanners() {
  ...
  wrap.innerHTML =
    '<a class="promo-banner" href="' + generalWaLink() + '" target="_blank"><picture><source media="(max-width:768px)" srcset="assets/banner-promo2.png"><img src="assets/banner-promo1.png" alt="Atendimento totalmente humanizado"></picture></a>';
  return wrap;
}
